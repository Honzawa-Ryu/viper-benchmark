#!/bin/bash
#SBATCH --job-name=0002_20260918_eval_pathology_fms_organ_probe
#SBATCH --partition=x-large-grace-i
#SBATCH --output=/workspace/filesrv02/honzawa/02-playground/viper-benchmark/logs/0002_20260918_eval_pathology_fms_organ_probe/%j_0002_20260918_eval_pathology_fms_organ_probe.out
#SBATCH --error=/workspace/filesrv02/honzawa/02-playground/viper-benchmark/logs/0002_20260918_eval_pathology_fms_organ_probe/%j_0002_20260918_eval_pathology_fms_organ_probe.out
...
# #SBATCH --output=/workspace/filesrv02/honzawa/02-playground/viper-benchmark/logs/0002_20260918_eval_pathology_fms_organ_probe/%A_%a_0002_20260918_eval_pathology_fms_organ_probe.out
# #SBATCH --error=/workspace/filesrv02/honzawa/02-playground/viper-benchmark/logs/0002_20260918_eval_pathology_fms_organ_probe/%A_%a_0002_20260918_eval_pathology_fms_organ_probe.out
# #SBATCH --array=0-N
#
...
export PROJECT_ROOT="/workspace/filesrv02/honzawa/02-playground/viper-benchmark"
export EXP_NAME="0002_20260918_eval_pathology_fms_organ_probe"
...
# grace01は/scratchが書き込み不可(Permission denied)なため、0001と同じ理由で
# ここは必ず0にする(EXPERIMENT_NOTES.md参照)。
